...
/***/ "./src/js/components/followCursor.js":
/*!*******************************************!*\
  !*** ./src/js/components/followCursor.js ***!
  \*******************************************/
...
var followCursor = function followCursor() {
  var ball = document.querySelector('.order-btn__wrapper'),
      ...
      timelineRotate = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
    defaults: {
      ease: 'none',
      duration: 40
    }
  ...
  container.addEventListener('mouseleave', function () {
    ...
    if (introSection.classList.contains('animation-intro')) {
      console.log(true);
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(ball, {
        scale: 1,
        x: 0,
        y: 0,
        duration: 0.3,
...
/* harmony default export */ __webpack_exports__["default"] = (followCursor);

/***/ }),

/***/ "./src/js/components/gsapAnimTabs.js":
/*!*******************************************!*\
  !*** ./src/js/components/gsapAnimTabs.js ***!
  \*******************************************/
/*! exports provided: slideShow, slideHide */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var slideShow = function slideShow(el) {
  var value = window.offsetWidth;
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(el, {
    scale: 1.3,
    zIndex: 3,
    x: window.innerWidth,
    ease: gsap_gsap_core__WEBPACK_IMPORTED_MODULE_1__["Power2"].easeOut,
    duration: 1
  }, {
    scale: 1,
    x: -value,
...
var slideHide = function slideHide(el) {
...
/***/ "./src/js/components/gsapSmoothScroll.js":
/*!***********************************************!*\
  !*** ./src/js/components/gsapSmoothScroll.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony import */ var _headerOnScroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./headerOnScroll */ "./src/js/components/headerOnScroll.js");
...
var scrollFunction = function scrollFunction(container, btnClass) {
  var btn = document.querySelector(btnClass),
      btnStyles = window.getComputedStyle(btn),
      elem = document.querySelector(container);

  var scrollbar = new locomotive_scroll__WEBPACK_IMPORTED_MODULE_1__["default"]({
    ...
    smoothMobile: true
      ...
      tabImagesList = _toConsumableArray(document.querySelectorAll('.about__tab__img ')),
      tabList = document.querySelector('.about__tabs__list'),
      header = document.querySelector('.header'),
      vh = window.innerHeight / 100,
      startAnimationPosition = scrollContent.height - vh * 15;

  var animation1 = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
    defaults: {
      ease: gsap__WEBPACK_IMPORTED_MODULE_0__["Power2"].easeOut,
      duration: 0.8
    }
  }),
      animation2 = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
    defaults: {
      ease: gsap__WEBPACK_IMPORTED_MODULE_0__["Power4"].easeOut,
      duration: 1
    }
  }),
      animation3 = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
    defaults: {
      ease: gsap__WEBPACK_IMPORTED_MODULE_0__["Power4"].easeOut,
      duration: 0.9
    }
  }),
      animation4 = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
    defaults: {
      ease: gsap__WEBPACK_IMPORTED_MODULE_0__["Power2"].easeIn,
      duration: 1
    }
  }),
      isAnimation = false,
  ...
  scrollbar.on('scroll', function (status) {
    var offset = status.scroll,
    ...
    if (window.innerWidth > 1024) {
      if (aboutSection.classList.contains('animation-about')) {
        ...
        Object(_headerOnScroll__WEBPACK_IMPORTED_MODULE_3__["default"])(offset.y); //header position
      }
      ...
      if (offset.y > 2 && !isScrollDocument) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(btn.querySelector('.order-btn__wrapper'), {
          duration: 0.5,
          scale: 0.9,
          y: 80
        });
      ...
      if (scrollPosition >= startAnimationPosition && !isAnimation) {
        var tabsOffset = tabsSection.getBoundingClientRect(); // Btn scale out
  ...
  window.addEventListener('resize', function () {
    ...
    if (window.innerWidth <= 1024) {
      var imgActiveClass = tabImagesList.findIndex(function (el) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var headerOnScroll = function headerOnScroll(offsetY) {
...
/* harmony default export */ __webpack_exports__["default"] = (headerOnScroll);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _touchDevice__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./touchDevice */ "./src/js/components/touchDevice.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
var hover = function hover(el) {
  var mobile = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var element = el.length > 1 ? _toConsumableArray(document.querySelectorAll(el)) : el;

  function toggleClass(item) {
    if (!Object(_touchDevice__WEBPACK_IMPORTED_MODULE_0__["default"])()) {
    ...
    } else if (Object(_touchDevice__WEBPACK_IMPORTED_MODULE_0__["default"])() && mobile) {
  ...
  el.length > 1 ? element.map(function (item) {
    return toggleClass(item);
  }) : toggleClass(el);
};
...
/***/ "./src/js/components/imageSizeCalculation.js":
/*!***************************************************!*\
  !*** ./src/js/components/imageSizeCalculation.js ***!
  \***************************************************/
/*! exports provided: default */
...
var imageSizeCalculation = function imageSizeCalculation() {
  function reset(el) {
  ...
  function setup(el) {
    ...
    var widthBasedOnHeight = defaultWidth / defaultHeight * height;

    if (widthBasedOnHeight >= width) {
      el.style.width = widthBasedOnHeight + 'px';
      el.style.height = height + 'px';
    } else {
      var heightBasedOnWidth = defaultHeight / defaultWidth * width;
      el.style.width = width + 'px';
      el.style.height = heightBasedOnWidth + 'px';
    }
  }

  var images = _toConsumableArray(document.querySelectorAll('.about__tab__img'));
...
/* harmony default export */ __webpack_exports__["default"] = (imageSizeCalculation);
...
function navMobile() {
  var burgerBtn = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.js-nav';
  var nav = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '.js-nav-aside';
  var subMenu = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '.js-nav-overlay';
  var overlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '.js-nav-overlay';

  var btn = document.querySelector(burgerBtn),
      navigation = document.querySelector(nav),
      menuItems = _toConsumableArray(document.querySelectorAll('.menu-item a')),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _gsapAnimTabs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gsapAnimTabs */ "./src/js/components/gsapAnimTabs.js");
/* harmony import */ var _touchDevice__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./touchDevice */ "./src/js/components/touchDevice.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
var getImageByAttr = function getImageByAttr(elem) {
  var attr = elem.getAttribute('data-name');
  return document.querySelector(".about__tab__img[data-name=".concat(attr, "]"));
};

var tabs = function tabs() {
  var tabsArray = _toConsumableArray(document.querySelectorAll('.about__tab__link'));

  tabsArray.forEach(function (el, i) {
    var img = getImageByAttr(el);

    function removeHover() {
      if (!img.classList.contains('active')) {
        Object(_gsapAnimTabs__WEBPACK_IMPORTED_MODULE_0__["slideHide"])(img);
        el.removeEventListener('mouseleave', removeHover);
      }
    }

    if (!Object(_touchDevice__WEBPACK_IMPORTED_MODULE_1__["default"])()) {
      el.addEventListener('mouseenter', function () {
        if (!img.classList.contains('active')) {
          img.style.zIndex = 3;
          Object(_gsapAnimTabs__WEBPACK_IMPORTED_MODULE_0__["slideShow"])(img);
    ...
    el.addEventListener('click', function (ev) {
      ...
      if (!el.classList.contains('active')) {
        //Element isn't already active
        var previousImage;
        el.removeEventListener('mouseleave', removeHover);
        tabsArray.forEach(function (elem, j) {
          var currentImage = getImageByAttr(elem);
...
/***/ "./src/js/components/touchDevice.js":
/*!******************************************!*\
  !*** ./src/js/components/touchDevice.js ***!
  \******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (touchDevice);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_gsapSmoothScroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/gsapSmoothScroll */ "./src/js/components/gsapSmoothScroll.js");
/* harmony import */ var _components_hover__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/hover */ "./src/js/components/hover.js");
/* harmony import */ var _components_imageSizeCalculation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/imageSizeCalculation */ "./src/js/components/imageSizeCalculation.js");
...
/* harmony import */ var _components_followCursor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/followCursor */ "./src/js/components/followCursor.js");
/* harmony import */ var _components_navMobile__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/navMobile */ "./src/js/components/navMobile.js");
...
document.addEventListener('DOMContentLoaded', function () {
  Object(_components_gsapSmoothScroll__WEBPACK_IMPORTED_MODULE_0__["default"])('.smooth-content', '.order-btn');
  Object(_components_navMobile__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_components_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_components_hover__WEBPACK_IMPORTED_MODULE_1__["default"])('.js-hover', true);
  Object(_components_hover__WEBPACK_IMPORTED_MODULE_1__["default"])('.js-card-hover');

  if (window.innerWidth > 1024) {
    Object(_components_imageSizeCalculation__WEBPACK_IMPORTED_MODULE_2__["default"])();
    Object(_components_followCursor__WEBPACK_IMPORTED_MODULE_4__["default"])();
  } else {
    document.querySelector('.first-img').classList.add('active');
  }
});
